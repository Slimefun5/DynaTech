...
public class GrowthChamberNetherMK2 extends AbstractElectricMachine {
    ...
    protected void registerDefaultRecipes() {
        ...
        registerRecipe(12, new ItemStack(MaterialCompat.safe(XMaterial.NETHER_WART)), new ItemStack(MaterialCompat.safe(XMaterial.NETHER_WART), 12));
        registerRecipe(9, new ItemStack(MaterialCompat.safe(XMaterial.WEEPING_VINES)), new ItemStack(MaterialCompat.safe(XMaterial.WEEPING_VINES), 12));
        registerRecipe(9, new ItemStack(MaterialCompat.safe(XMaterial.TWISTING_VINES)), new ItemStack(MaterialCompat.safe(XMaterial.TWISTING_VINES), 12));
        registerRecipe(9, new ItemStack(MaterialCompat.safe(XMaterial.CRIMSON_ROOTS)), new ItemStack(MaterialCompat.safe(XMaterial.CRIMSON_ROOTS), 12));
        registerRecipe(9, new ItemStack(MaterialCompat.safe(XMaterial.WARPED_ROOTS)), new ItemStack(MaterialCompat.safe(XMaterial.WARPED_ROOTS), 12));
        registerRecipe(9, new ItemStack(MaterialCompat.safe(XMaterial.NETHER_SPROUTS)), new ItemStack(MaterialCompat.safe(XMaterial.NETHER_SPROUTS), 12));

        registerRecipe(30, new ItemStack[] {new ItemStack(MaterialCompat.safe(XMaterial.CRIMSON_FUNGUS))}, new ItemStack[] {new ItemStack(MaterialCompat.safe(XMaterial.CRIMSON_FUNGUS), 6), new ItemStack(MaterialCompat.safe(XMaterial.CRIMSON_STEM), 18), new ItemStack(MaterialCompat.safe(XMaterial.SHROOMLIGHT), 6), new ItemStack(MaterialCompat.safe(XMaterial.NETHER_WART_BLOCK), 12)});
        registerRecipe(30, new ItemStack[] {new ItemStack(MaterialCompat.safe(XMaterial.WARPED_FUNGUS))}, new ItemStack[] {new ItemStack(MaterialCompat.safe(XMaterial.WARPED_FUNGUS), 6), new ItemStack(MaterialCompat.safe(XMaterial.WARPED_STEM), 18), new ItemStack(MaterialCompat.safe(XMaterial.SHROOMLIGHT), 6), new ItemStack(MaterialCompat.safe(XMaterial.WARPED_WART_BLOCK), 12)});
